(function () {
    ...
    (function (drunk) {
        ...
        var ComponentBinding = (function () {
            ...
            ComponentBinding.prototype.release = function () {
                ...
                // 移除所有的属性监控
                this.unwatches && this.unwatches.forEach(function (unwatch) {
                    return unwatch();
                });
                this._startNode && drunk.dom.remove(this._startNode);
                this._endedNode && drunk.dom.remove(this._endedNode);
                // 移除所有引用
                this._startNode = null;
                this._endedNode = null;
                this.component = null;
    ...
    drunk.xhr = drunk.util.ajax;

    esun.def('drunk.util', function () { return drunk.util });
    esun.def('drunk.xhr', function () { return drunk.xhr });
    esun.def('drunk.dom', function () { return drunk.dom });
    esun.def('drunk.config', function () { return drunk.config });
    esun.def('drunk.cache', function () { return drunk.Cache });
    esun.def('drunk.map', function () { return drunk.Map });
    esun.def('drunk.template', function () { return drunk.Template });
    esun.def('drunk.binding', function () { return drunk.Binding });
    esun.def('drunk.promise', function () { return drunk.Promise });
    esun.def('drunk.watcher', function () { return drunk.Watcher });
    esun.def('drunk.observable', function () { return drunk.observable });
    esun.def('drunk.filter', function () { return drunk.filter })
    esun.def('drunk.events', function () { return drunk.EventEmitter });
    esun.def('drunk.parser', function () { return drunk.parser });
    esun.def('drunk.scheduler', function () { return drunk.Scheduler });
    esun.def('drunk.viewmodel', function () { return drunk.ViewModel });
    esun.def('drunk.component', function () { return drunk.Component });
    esun.def("drunk", function () { return drunk });
